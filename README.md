...
전체 목록·읽는 순서는 [`docs/README.md`](docs/README.md) 색인 참고.

- [기술 스택 결정](docs/01-기술스택-결정.md)
- [v1 핵심 기능 기획](docs/02-기획-v1-핵심기능.md)
- [v2 기획 — 자동복구·백업·릴리스](docs/03-기획-v2-자동복구-백업-릴리스.md)
- [v3 기획 — 오버레이·학습 잔디](docs/04-기획-v3-오버레이-학습잔디.md)
- [안정성 보강 (v3.1.1)](docs/05-안정성-보강-v3.1.1.md)
- [자동 업데이트 (v3.2.0)](docs/06-자동-업데이트-v3.2.0.md)
- [v4 기획 — 자동 백업](docs/07-기획-v4-자동백업.md)
...
- 학습 기록(과목·시간·메모 등) 데이터는 **내 PC의 로컬 저장소(SQLite)에만** 저장되며, 외부 서버로 전송하거나 수집하지 않습니다.
- **[문의] 기능**을 이용할 경우 입력한 문의 내용과 앱 버전·실행 환경 정보가 개발자에게 이메일로 전달됩니다. 답장받을 이메일은 **선택 입력**이며, 입력한 경우 **문의 답변 목적으로만** 사용되고 별도로 보관·공유하지 않습니다.
- GitHub 백업을 켜면 데이터가 **사용자 본인의 GitHub 저장소**에 저장됩니다(개발자에게 전송되지 않음).
